...
Public Class ResourceProvider
    ...
    Private Sub ConfigureServices(services As IServiceCollection)
        services.AddTransient(Of DbConnection)(Function(sp) New SqlConnection(ConfigurationManager.ConnectionStrings("AccountManager").ConnectionString))
        services.AddScoped(Of AuthService)()
        services.AddScoped(Of AccountService)()
    End Sub
